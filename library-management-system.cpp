// Library Management System in CPP task 3 for Codsoft Internship
// Coded and Submitted by Shweta (Shwetatyagi489@gmail.com)
...
int library_mgmt()
{
    ...
    start:
    cout<<"\n------------------------- LIBRARY MANAGEMENT SYSTEM CODED IN CPP BY SHWETA -------------------------"<<endl;
...
int main()
{
    ...
    login.insert({"shweta", 167});
    login.insert({"shwetatyagi", 13579});
